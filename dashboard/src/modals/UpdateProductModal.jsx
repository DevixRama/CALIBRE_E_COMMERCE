    ...
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center p-4">
      <div className="bg-white rounded-xl w-full max-w-2xl p-6 relative">
        <button
          ...
          className="absolute top-4 right-4 text-gray-600 hover:text-purple-600 text-xl"
        >
          &times;
        </button>

        <h2 className="text-2xl font-bold mb-4 text-center text-purple-700">Update Product</h2>
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white py-2 px-6 rounded col-span-1 md:col-span-2"
          >
            {loading ? (
              <>
