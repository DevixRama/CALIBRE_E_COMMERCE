...
export const fetchAllProducts = createAsyncThunk("product-fetchAllProducts", async ({ availability = "", price = "1-10000", category = "", ratings = "", search = "", page = 1 }, thunkAPI) => {
  try {
    price
...
export const fetchProductDetails = createAsyncThunk("product-fetchSingleProduct", async (productId, thunkAPI) => {
  try {
...
export const postReview = createAsyncThunk("product-postReview", async ({ productId, review }, thunkAPI) => {
...
export const deleteReview = createAsyncThunk("product-deleteReview", async ({ productId, reviewId }, thunkAPI) => {
  try {
...
export const fetchProductWithAI = createAsyncThunk("product-fetchProductWithAI", async (userPrompt, thunkAPI) => {
  try {
